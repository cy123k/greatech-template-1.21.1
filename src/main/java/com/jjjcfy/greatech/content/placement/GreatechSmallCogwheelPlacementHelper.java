/*
 * Create compatibility note: this placement helper integrates with Create/Catnip's MIT-licensed
 * cogwheel placement APIs. See THIRD_PARTY_NOTICES.md.
 */
package com.jjjcfy.greatech.content.placement;
