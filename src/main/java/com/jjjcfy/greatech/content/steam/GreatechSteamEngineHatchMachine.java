/*
 * GTCEu compatibility note: this machine part integrates with GTCEu Modern's LGPL-licensed
 * multiblock part and machine trait APIs. See THIRD_PARTY_NOTICES.md.
 */
