/*
 * Create compatibility note: this belt-processing behavior integrates with and follows parts of
 * Create's MIT-licensed processing API shape. See THIRD_PARTY_NOTICES.md.
 */
