...
- [GreatechCogwheelBlock.java](../../src/main/java/com/jjjcfy/greatech/content/cogwheel/GreatechCogwheelBlock.java)
- [GreatechCogwheelBlockEntity.java](../../src/main/java/com/jjjcfy/greatech/content/cogwheel/GreatechCogwheelBlockEntity.java)
- [GreatechLargeCogwheelBlockEntity.java](../../src/main/java/com/jjjcfy/greatech/content/cogwheel/GreatechLargeCogwheelBlockEntity.java)
- [GreatechCogwheelRenderer.java](../../src/main/java/com/jjjcfy/greatech/content/cogwheel/GreatechCogwheelRenderer.java)
...
- encased small cogwheel block ids: `<encasing>_encased_<material>_cogwheel`
- large cogwheel block ids: `<material>_large_cogwheel`
- encased large cogwheel block ids: `<encasing>_encased_<material>_large_cogwheel`
...
- generated encased small wrapper models: `generated/assets/greatech/models/block/cogwheel/small_cogwheel/encased/<encasing>_encased_<material>_cogwheel*.json`
- large wrapper models: `models/block/cogwheel/large_cogwheel/<material>_large_cogwheel*.json`
- generated encased large wrapper models: `generated/assets/greatech/models/block/cogwheel/large_cogwheel/encased/<encasing>_encased_<material>_large_cogwheel*.json`
...
- `generated/assets/greatech/blockstates/<encasing>_encased_<material>_cogwheel.json`
...
- `generated/assets/greatech/models/item/<encasing>_encased_<material>_cogwheel.json`
...
- `generated/data/greatech/loot_table/blocks/<encasing>_encased_<material>_cogwheel.json`
...
- `generated/assets/greatech/blockstates/<encasing>_encased_<material>_large_cogwheel.json`
- `generated/assets/greatech/models/item/<material>_large_cogwheel.json`
- `generated/assets/greatech/models/item/<encasing>_encased_<material>_large_cogwheel.json`
- `generated/data/greatech/loot_table/blocks/<material>_large_cogwheel.json`
- `generated/data/greatech/loot_table/blocks/<encasing>_encased_<material>_large_cogwheel.json`
...
- `generated/assets/greatech/models/block/cogwheel/small_cogwheel/encased/<encasing>_encased_<material>_cogwheel*.json`: Create casing shell wrappers for encased small cogwheels
- `generated/assets/greatech/models/block/cogwheel/large_cogwheel/encased/<encasing>_encased_<material>_large_cogwheel*.json`: Create casing shell wrappers for encased large cogwheels
...
Generated encased small and large cogwheel blockstates use Create's `axis`, `top_shaft`, and `bottom_shaft` pattern.
The matching wrapper models are generated by [GreatechEncasedModelProvider.java](../../src/main/java/com/jjjcfy/greatech/datagen/GreatechEncasedModelProvider.java), using texture metadata from `GreatechEncasingType`.
The four casing wrapper suffixes are:

- no suffix: no exposed shaft cap
- `_top`: exposed positive-axis shaft cap
- `_bottom`: exposed negative-axis shaft cap
- `_top_bottom`: exposed caps on both axis ends
...
The renderer selects the partial by cogwheel size and casing state:
...
For `GreatechEncasedCogwheelBlock`, the renderer uses the matching small or large `*_shaftless` partial instead.
The baked blockstate model contributes the Create casing shell and shaft caps, while the BER contributes the rotating Greatech material cogwheel and separate rotating shaft halves.
Encased cogwheels also borrow light through `GreatechLightSampler`, matching the encased shaft lighting path.
...
- bare small cogwheel items can use Greatech encased small cogwheel targets as placement anchors
...
- bare large cogwheel items can use Greatech encased large cogwheel targets as placement anchors
...
Greatech small and large cogwheels are registered with Create's `EncasingRegistry` during common setup.

Current small and large cogwheel behavior:

- `create:andesite_casing` encases Greatech small cogwheels as `greatech:andesite_encased_<material>_cogwheel`
- `create:brass_casing` encases Greatech small cogwheels as `greatech:brass_encased_<material>_cogwheel`
- `create:andesite_casing` encases Greatech large cogwheels as `greatech:andesite_encased_<material>_large_cogwheel`
- `create:brass_casing` encases Greatech large cogwheels as `greatech:brass_encased_<material>_large_cogwheel`
- the casing item is not consumed, matching Create's current encasing behavior
- the encased block keeps the original Greatech material, Greatech block entity type, and kinetic break limit
- wrenching an axis face toggles `top_shaft` / `bottom_shaft`
- sneak-wrenching removes the casing and restores the matching Greatech cogwheel
...
- [GreatechEncasedCogwheelBlock.java](../../src/main/java/com/jjjcfy/greatech/content/cogwheel/GreatechEncasedCogwheelBlock.java)
...
5. Ensure `GreatechEncasingType` has the required encased cogwheel casing, side, cap, and opening textures.
6. Add lang entries for normal, powered, large, and encased small cogwheel blocks/items.
7. Run datagen so blockstates, item model roots, and loot tables are generated.
