...
The matching wrapper models are generated by [GreatechEncasedModelProvider.java](../../src/main/java/com/greatech/datagen/GreatechEncasedModelProvider.java), using texture metadata from `GreatechEncasingType`.
...
- [GreatechEncasedCogwheelBlock.java](../../src/main/java/com/greatech/content/cogwheel/GreatechEncasedCogwheelBlock.java)
